...
class Dosen extends CI_Controller
{
    ...
    public function action_pengajuan()
    {
        ...
        $id_berkas = $this->berkas->berkas($data);
        for ($i = 1; $i <= 18; $i++) {
            $postdata = $this->input->post('bk' . $i);

            if (strpos($postdata, 'http') !== false) {
                $this->berkas->update_berkas($id_berkas, 'berkas_' . $i, $postdata);
            } else {
                ...
                if ($_FILES[$abc]['name'] != null) {
                    $this->berkas->update_berkas($id_berkas, 'berkas_' . $i, $filename . '.pdf');
                }
            }
        }
    ...
    public function action_pendidikan()
    {
        ...
        if ($a21 != NULL) {
            for ($i = 0; $i < count($a21); $i++) {
                if ($a21[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_a2';
                    $this->berkas->a2($id_pengajuan, $a21[$i], $a22[$i], $a23[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b21 != NULL) {
            for ($i = 0; $i < count($b21); $i++) {
                if ($b21[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b2';
                    $this->berkas->b2($id_pengajuan, $b21[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b31 != NULL) {
            for ($i = 0; $i < count($b31); $i++) {
                if ($b31[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b3';
                    $this->berkas->b3($id_pengajuan, $b31[$i], $b32[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b41 != NULL) {
            for ($i = 0; $i < count($b41); $i++) {
                if ($b41[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b4';
                    $this->berkas->b4($id_pengajuan, $b41[$i], $b42[$i], $b43[$i], $b44[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b51 != NULL) {
            for ($i = 0; $i < count($b51); $i++) {
                if ($b51[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b5';
                    $this->berkas->b5($id_pengajuan, $b51[$i], $b52[$i], $b53[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b61 != NULL) {
            for ($i = 0; $i < count($b61); $i++) {
                if ($b61[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b6';
                    $this->berkas->b6($id_pengajuan, $b61[$i], $b62[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b71 != NULL) {
            for ($i = 0; $i < count($b71); $i++) {
                if ($b71[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b7';
                    $this->berkas->b7($id_pengajuan, $b71[$i], $b72[$i], $b73[$i], $b74[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b81 != NULL) {
            for ($i = 0; $i < count($b81); $i++) {
                if ($b81[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b8';
                    $this->berkas->b8($id_pengajuan, $b81[$i], $b82[$i], $b83[$i], $b84[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b91 != NULL) {
            for ($i = 0; $i < count($b91); $i++) {
                if ($b91[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b9';
                    $this->berkas->b9($id_pengajuan, $b91[$i], $b92[$i], $b93[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b101 != NULL) {
            for ($i = 0; $i < count($b101); $i++) {
                if ($b101[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b10';
                    $this->berkas->b10($id_pengajuan, $b101[$i], $b102[$i], $b103[$i], $filename);
                }
                $filenames[] = $filename;
                if ($b101[$i] == 'Direktur') {
                    $ak = 4;
        ...
        if ($b111 != NULL) {
            for ($i = 0; $i < count($b111); $i++) {
                if ($b111[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b11';
                    $this->berkas->b11($id_pengajuan, $b111[$i], $b112[$i], $b113[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b121 != NULL) {
            for ($i = 0; $i < count($b121); $i++) {
                if ($b121[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b12';
                    $this->berkas->b12($id_pengajuan, $b121[$i], $b122[$i], $b123[$i], $filename);
                }
                $filenames[] = $filename;
        ...
        if ($b131 != NULL) {
            for ($i = 0; $i < count($b131); $i++) {
                if ($b131[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_b13';
                    $this->berkas->b13($id_pengajuan, $b131[$i], $filename);
                }
                $filenames[] = $filename;
                if ($b131[$i] == '> 960 jam') {
                    $ak = 15;
    ...
    public function action_penelitian()
    {
        ...
        if ($c11 != NULL) {
            for ($i = 0; $i < count($c11); $i++) {
                if ($c11[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c1';
        ...
        if ($c21 != NULL) {
            for ($i = 0; $i < count($c21); $i++) {
                if ($c21[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c2';
        ...
        if ($c31 != NULL) {
            for ($i = 0; $i < count($c31); $i++) {
                if ($c31[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c3';
        ...
        if ($c41 != NULL) {
            for ($i = 0; $i < count($c41); $i++) {
                if ($c41[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c4';
        ...
        if ($c51 != NULL) {
            for ($i = 0; $i < count($c51); $i++) {
                if ($c51[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c5';
        ...
        if ($c61 != NULL) {
            for ($i = 0; $i < count($c61); $i++) {
                if ($c61[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c6';
        ...
        if ($c71 != NULL) {
            for ($i = 0; $i < count($c71); $i++) {
                if ($c71[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c7';
        ...
        if ($c81 != NULL) {
            for ($i = 0; $i < count($c81); $i++) {
                if ($c81[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_c8';
    ...
    public function action_pengmas()
    {
        ...
        if ($d11 != NULL) {
            for ($i = 0; $i < count($d11); $i++) {
                if ($d11[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d1';
        ...
        if ($d21 != NULL) {
            for ($i = 0; $i < count($d21); $i++) {
                if ($d21[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d2';
        ...
        if ($d31 != NULL) {
            for ($i = 0; $i < count($d31); $i++) {
                if ($d31[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d3';
        ...
        if ($d41 != NULL) {
            for ($i = 0; $i < count($d41); $i++) {
                if ($d41[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d4';
        ...
        if ($d51 != NULL) {
            for ($i = 0; $i < count($d51); $i++) {
                if ($d51[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d5';
        ...
        if ($d61 != NULL) {
            for ($i = 0; $i < count($d61); $i++) {
                if ($d61[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d6';
        ...
        if ($d71 != NULL) {
            for ($i = 0; $i < count($d71); $i++) {
                if ($d71[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_d7';
    ...
    public function action_penunjang()
    {
        ...
        if ($e11 != NULL) {
            for ($i = 0; $i < count($e11); $i++) {
                if ($e11[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e1';
        ...
        if ($e21 != NULL) {
            for ($i = 0; $i < count($e21); $i++) {
                if ($e21[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e2';
        ...
        if ($e31 != NULL) {
            for ($i = 0; $i < count($e31); $i++) {
                if ($e31[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e3';
        ...
        if ($e41 != NULL) {
            for ($i = 0; $i < count($e41); $i++) {
                if ($e41[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e4';
        ...
        if ($e51 != NULL) {
            for ($i = 0; $i < count($e51); $i++) {
                if ($e51[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e5';
        ...
        if ($e61 != NULL) {
            for ($i = 0; $i < count($e61); $i++) {
                if ($e61[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e6';
        ...
        if ($e71 != NULL) {
            for ($i = 0; $i < count($e71); $i++) {
                if ($e71[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e7';
        ...
        if ($e81 != NULL) {
            for ($i = 0; $i < count($e81); $i++) {
                if ($e81[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e8';
        ...
        if ($e91 != NULL) {
            for ($i = 0; $i < count($e91); $i++) {
                if ($e91[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e9';
        ...
        if ($e101 != NULL) {
            for ($i = 0; $i < count($e101); $i++) {
                if ($e101[$i] != "") {
                    $filename = $this->session->userdata('nip') . '_' . $id_pengajuan . '_' . $i . '_e10';
    ...
    public function test()
    {
        ...
        if ($this->m_verif->cek_verifikator()==null) {
            echo "OK";
        }else{
            echo "salah dong";
        }
