<div class="container-fluid">
    ...
    <div class="container" style="height: 95%;">
        ...
        <form class="user" enctype='multipart/form-data' method="post" action="<?= base_url('admin/action_penetapan_ak'); ?>">
                            ...
                            <tbody>
                                ...
                                foreach ($a1 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_a1_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($a2 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_a2_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b1 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b1_final[]" step="0.01" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b2 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b2_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b3 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b3_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b4 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b4_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b5 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b5_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b6 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b6_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b7 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b7_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b8 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b8_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b9 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b9_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b10 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b10_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b11 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b11_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b12 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b12_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($b13 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_b13_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c1 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c1_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c2 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c2_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c3 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c3_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c4 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c4_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c5 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c5_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c6 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c6_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c7 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c7_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($c8 as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value['ak_p2'] ?></td>
                                            <td><?= $value['ak_p3'] ?></td>
                                            <td><input type="number" name="nilai_c8_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                        </tr>
                                    <?php $urut++;
                                    }
                                    unset($urut); ?>
            ...
            <div id="pengmas" class="tabcontent pt-5">
                ...
                <!-- Penetapan Pengabdian Masyarakat -->
                <div class="container-fluid p-5">
                            ...
                            <tbody>
                                ...
                                foreach ($d1 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d1_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d2 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d2_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d3 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d3_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d4 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d4_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d5 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d5_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d6 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d6_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($d7 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_d7_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e1 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e1_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e2 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e2_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e3 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e3_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e4 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e4_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e5 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e5_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e6 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e6_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e7 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e7_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e8 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e8_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e9 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e9_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($e10 as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?= $value['ak_p2']; ?></td>
                                        <td><?= $value['ak_p3']; ?></td>
                                        <td><input type="number" name="nilai_e10_final[]" step="0.1" max="<?= $value['ak_maks']; ?>" style="width: 4rem;"></input></td>
                                    </tr>
                                <?php $urut++;
                                }
                                unset($urut); ?>
            ...
            <div class="container-fluid row pb-4 pt-2">
                <div class="container" style="width: 30%; text-align: center;">
                    <button data-toggle="modal" type="button" data-target="#lanjutkanResume" style="font-weight: bold; height: 50px; width: 250px;" class="btn btn-dark text-center btn-user btn=block">
                        Tolak Pengajuan
                    </button>
                </div>
                <div class="container" style="width: 30%; text-align: center;">
                ...
                <div class="container" style="width: 30%; text-align: center;">
                    <button data-toggle="modal" type="button" data-target="#tetapkan_ak" style="font-weight: bold; height: 50px; width: 250px;" class="btn btn-primary text-center btn-user btn=block">
            ...
            <!-- Modal Tetapkan Angka Kredit -->
            <div class="modal fade" id="tetapkan_ak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tetapkan Angka Kredit</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">Klik Lanjutkan Untuk Menyimpan Penetapan Peilaian Angka Kredit</div>
