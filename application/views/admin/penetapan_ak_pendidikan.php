                    ...
                    <tbody>
                        ...
                        foreach ($a1 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_a1_final[]" step="0.1" max="<?= $maks_a1[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($a2 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_a2_final[]" step="0.1" max="<?= $maks_a2[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b1 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b1_final[]" step="0.01" max="<?= $maks_b1[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b2 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b2_final[]" step="0.1" max="<?= $maks_b2[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b3 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b3_final[]" step="0.1" max="<?= $maks_b3[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b4 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b4_final[]" step="0.1" max="<?= $maks_b4[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b5 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b5_final[]" step="0.1" max="<?= $maks_b5[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b6 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b6_final[]" step="0.1" max="<?= $maks_b6[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b7 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b7_final[]" step="0.1" max="<?= $maks_b7[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b8 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b8_final[]" step="0.1" max="<?= $maks_b8[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b9 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b9_final[]" step="0.1" max="<?= $maks_b9[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b10 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b10_final[]" step="0.1" max="<?= $maks_b10[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b11 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b11_final[]" step="0.1" max="<?= $maks_b11[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b12 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b12_final[]" step="0.1" max="<?= $maks_b12[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
                    ...
                    <tbody>
                        ...
                        foreach ($b13 as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $value['ak_p2']; ?></td>
                                <td><?= $value['ak_p3']; ?></td>
                                <td><input type="number" name="nilai_b13_final[]" step="0.1" max="<?= $maks_b13[$urut]['ak_maksimal']; ?>" style="width: 4rem;"></input></td>
                            </tr>
                        <?php $urut++;
                        }
                        unset($urut); ?>
